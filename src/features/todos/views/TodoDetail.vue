...
<template>
  <div>
    ...
    <div class="p-6">
      <div class="mb-4">
        <Button icon="pi pi-arrow-left" label="Back to Todos" severity="secondary" @click="goBack" />
      </div>
        ...
        <Card>
          <template #title>
            <div class="flex items-center gap-3">
              ...
              <Badge :value="todo.completed ? 'Completed' : 'Pending'"
          ...
          <template #content>
            <div class="space-y-4">
              <div class="flex items-center gap-2">
                <Checkbox id="completed-checkbox" v-model="todo.completed" binary @change="toggleCompleted" />
              ...
              <div v-if="todo.categories && todo.categories.length > 0"
                class="bg-surface-50 dark:bg-surface-800 p-4 rounded-lg">
                <h3 class="font-semibold text-lg mb-2">Categories</h3>
                <div class="flex flex-wrap gap-2">
                  <Badge v-for="category in todo.categories" :key="category.key" :value="category.name"
                    severity="info" />
                </div>
              </div>
          ...
          <template #footer>
            <div class="flex gap-2">
              ...
              <Button icon="pi pi-pencil" label="Edit" severity="warn"
